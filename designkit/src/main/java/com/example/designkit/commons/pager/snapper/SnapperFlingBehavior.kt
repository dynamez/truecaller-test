...
package com.example.designkit.commons.pager.snapper
...
import com.example.designkit.commons.pager.snapper.SnapperFlingBehaviorDefaults.MaximumFlingDistance
import com.example.designkit.commons.pager.snapper.SnapperFlingBehaviorDefaults.SnapIndex
...
public fun rememberSnapperFlingBehavior(
    ...
    decayAnimationSpec: DecayAnimationSpec<Float> = rememberSplineBasedDecay(),
    springAnimationSpec: AnimationSpec<Float> = SnapperFlingBehaviorDefaults.SpringAnimationSpec,
    maximumFlingDistance: (SnapperLayoutInfo) -> Float = MaximumFlingDistance,
): SnapperFlingBehavior = remember(
    layoutInfo,
    decayAnimationSpec,
    springAnimationSpec,
...
public class SnapperFlingBehavior private constructor(
    ...
    public constructor(
        ...
        decayAnimationSpec: DecayAnimationSpec<Float>,
        springAnimationSpec: AnimationSpec<Float> = SnapperFlingBehaviorDefaults.SpringAnimationSpec,
        snapIndex: (SnapperLayoutInfo, startIndex: Int, targetIndex: Int) -> Int = SnapIndex,
    ) : this(
        layoutInfo = layoutInfo,
        decayAnimationSpec = decayAnimationSpec,
        springAnimationSpec = springAnimationSpec,
        ...
        maximumFlingDistance = @Suppress("DEPRECATION") MaximumFlingDistance,
    )
