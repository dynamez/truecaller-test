@file:JvmName("Pager")
package com.example.designkit.commons.pager
...
import androidx.compose.ui.unit.dp
import com.example.designkit.commons.pager.snapper.SnapOffsets
import com.example.designkit.commons.pager.snapper.SnapperFlingBehavior
import com.example.designkit.commons.pager.snapper.SnapperFlingBehaviorDefaults
import com.example.designkit.commons.pager.snapper.SnapperLayoutInfo
import com.example.designkit.commons.pager.snapper.rememberSnapperFlingBehavior
...
object PagerDefaults {
    ...
    fun flingBehavior(
        ...
        decayAnimationSpec: DecayAnimationSpec<Float> = rememberSplineBasedDecay(),
        snapAnimationSpec: AnimationSpec<Float> = SnapperFlingBehaviorDefaults.SpringAnimationSpec,
        endContentPadding: Dp = dimens.dimen0,
...
fun HorizontalPager(
    ...
    itemSpacing: Dp = dimens.dimen0,
    contentPadding: PaddingValues = PaddingValues(dimens.dimen0),
